<template>
    <div class="main-border">
        <el-menu default-active="1" class="el-menu-demo" mode="horizontal" @select="handleSelect">
            <el-menu-item index="1">Online Item</el-menu-item>
            <el-menu-item index="2">Offline Item</el-menu-item>
        </el-menu>
            ...
            <el-table-column label="Operation">
                <template slot-scope="scope">
                    <el-button
                            size="mini"
                            type="danger"
                            @click="makeOfflineGoods(scope.$index)">remove</el-button>
                </template>
            </el-table-column>
        </el-table>
            ...
            <el-table-column label="Operation">
                <template slot-scope="scope">
                    <el-button
                            size="mini"
                            type="danger"
                            @click="deleteGoods(scope.$index)">delete</el-button>
                </template>
            </el-table-column>
        </el-table>
        <div class="block">
